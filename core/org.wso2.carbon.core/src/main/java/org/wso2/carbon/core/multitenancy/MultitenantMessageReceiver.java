 	...
 	if (service.equals("")) {
        ...
        try {
            ...
            if (mainInMsgContext.getOperationContext() != null && tenantInMsgCtx.getOperationContext() != null) {
                ...
                Object nioAckProperty = tenantInMsgCtx.getProperty(NIO_ACK_REQUESTED);
                if (nioAckProperty != null) {
                    boolean nioAckRequested = tenantInMsgCtx.isPropertyTrue(NIO_ACK_REQUESTED);
                    mainInMsgContext.setProperty(NIO_ACK_REQUESTED, nioAckRequested);
                }
                Object httpSc = tenantInMsgCtx.getProperty(HTTP_SC);
                if (httpSc != null) {
